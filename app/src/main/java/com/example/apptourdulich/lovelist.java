...
//                        Application activity, int maTour, String tenTour,
...
//                                String soNgay, String image
                        holder.setLikeList(lovelist.this.getApplication(), thongTinTour.getMaTour(), thongTinTour.getTenTour(), thongTinTour.getPhuongTien(), thongTinTour.getKhachSan(), thongTinTour.getDonGia(), thongTinTour.getNgayKhoiHanh(), thongTinTour.getNgayketThuc(), thongTinTour.getMoTa(), thongTinTour.getTinhTrang(), thongTinTour.getKhuVuc(), thongTinTour.getNoiKhoiHanh(), thongTinTour.getSoNgay(), thongTinTour.getImage());
                        ...
                        Picasso.get().load(thongTinTour.getImage()).into(holder.imgList);
