...
import com.example.apptourdulich.Adapter.PhotoAdapter;
import com.example.apptourdulich.Adapter.SlideListTourAdapter;
...
public class fmHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView1=view.findViewById(R.id.rcvHotel);
...
//                        FragmentActivity activity, int maTour, String tenTour,
...
//                                String soNgay, String image
    ...
    private List<Photo> getListPhotoTour() {
        list= SingletonPattern.get().getmPhotos();

        return list;
    }
    private List<Photo> getListPhoto() {
        List<Photo> list=new ArrayList<>();
        list.add(new Photo(R.drawable.vt));
        list.add(new Photo(R.drawable.nt));
