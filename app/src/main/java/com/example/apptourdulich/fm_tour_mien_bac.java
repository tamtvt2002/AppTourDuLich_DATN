 ...
 * Use the {@link fm_tour_mien_bac#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fm_tour_mien_bac extends Fragment {
     ...
     * @return A new instance of fragment fm_tour_mien_bac.
     */
    // TODO: Rename and change types and number of parameters
    public static fm_tour_mien_bac newInstance(String param1, String param2) {
        fm_tour_mien_bac fragment = new fm_tour_mien_bac();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view= inflater.inflate(R.layout.fragment_fm_tour_mien_bac, container, false);
        {
...
//            String currentUserid = user.getPhoneNumber();///
            ...
            recyclerView = view.findViewById(R.id.cvMienBac);
            ...
            FirebaseRecyclerOptions<ThongTinTour> options =
                    new FirebaseRecyclerOptions.Builder<ThongTinTour>()
                            .setQuery(FirebaseDatabase.getInstance().getReference().child("Tour").orderByChild("khuVuc").equalTo("Miền Bắc"), ThongTinTour.class).build();
...
//                            String currentUserid = user.getPhoneNumber();///
                            ...
                            holder.setItem(getActivity(),thongTinTour.getMaTour(),thongTinTour.getTenTour(),thongTinTour.getPhuongTien(),thongTinTour.getKhachSan(),thongTinTour.getDonGia(),thongTinTour.getNgayKhoiHanh(),thongTinTour.getNgayketThuc(),thongTinTour.getMoTa(),thongTinTour.getTinhTrang(),thongTinTour.getKhuVuc(),thongTinTour.getNoiKhoiHanh(),thongTinTour.getSoNgay(),thongTinTour.getImage());
...
//                                }
//                            });
                            Picasso.get().load(image).into(holder.imageItemTour);
