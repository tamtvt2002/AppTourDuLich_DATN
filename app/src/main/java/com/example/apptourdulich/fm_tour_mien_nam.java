 ...
 * Use the {@link fm_tour_mien_nam#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fm_tour_mien_nam extends Fragment {
     ...
     * @return A new instance of fragment fm_tour_mien_nam.
     */
    // TODO: Rename and change types and number of parameters
    public static fm_tour_mien_nam newInstance(String param1, String param2) {
        fm_tour_mien_nam fragment = new fm_tour_mien_nam();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fm_tour_mien_nam, container, false);
...
//        String currentUserid = user.getPhoneNumber();///
        ...
        recyclerView = view.findViewById(R.id.rvMienNam);
        ...
        FirebaseRecyclerOptions<ThongTinTour> options =
                new FirebaseRecyclerOptions.Builder<ThongTinTour>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Tour").orderByChild("khuVuc").equalTo("Miền Nam"), ThongTinTour.class).build();
