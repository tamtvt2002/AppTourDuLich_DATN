...
import com.example.apptourdulich.infoHistory;
...
public class AdapterLichSu extends FirebaseRecyclerAdapter<ThongTinHoaDon,AdapterLichSu.MyViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull AdapterLichSu.MyViewHolder holder, int position, @NonNull ThongTinHoaDon model) {
        ...
        if(model.getStatus()){
            holder.tvStatusHis.setText("Đã Được Xác Nhận");
            holder.tvStatusHis.setTextColor("#00FF00".hashCode());
        }
        else {
            holder.tvStatusHis.setText("Chưa Được Xác Nhận");
            holder.tvStatusHis.setTextColor("#FF0000".hashCode());
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        TextView tvNameTourHis,tvNgaydiHis,tvNgayThanhtoanHis,tvTongtienHis,tvStatusHis;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tvStatusHis=itemView.findViewById(R.id.tvStatusHis);
