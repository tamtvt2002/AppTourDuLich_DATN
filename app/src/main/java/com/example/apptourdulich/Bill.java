    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThanhToan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ThongTinThongBao thongBao= new NotificationBuilder().maThongBao((int)maxidThongBao+1).soDienThoai(SoDienThoaiBill.getText().toString().trim())
                        .noiDung(noidung).ngaythongbao(currentDateandTime).build();
...
//                thongBao.setSoDienThoai(SoDienThoaiBill.getText().toString().trim());
                ...
                AlertDialog alertDialog = new AlertDialog.Builder( Bill.this).setTitle("Thông Báo").
                        setMessage(noidung).setPositiveButton("Đóng", new DialogInterface.OnClickListener() {
                    @Override
