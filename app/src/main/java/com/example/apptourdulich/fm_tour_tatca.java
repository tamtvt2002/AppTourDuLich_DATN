...
public class fm_tour_tatca extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fm_tour_tatca, container, false);

        Bundle bundle = getActivity().getIntent().getExtras();
        SoDienThoai = bundle.getString("SoDienThoai");
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
//        String currentUserid = user.getPhoneNumber();///
        String currentUserid = SoDienThoai;///"0123456789
        ...
        recyclerView = view.findViewById(R.id.rvTatCa);
        ...
        FirebaseRecyclerOptions<ThongTinTour> options =
                new FirebaseRecyclerOptions.Builder<ThongTinTour>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Tour"), ThongTinTour.class).build();
